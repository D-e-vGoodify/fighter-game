...
//    c.fillRect(this.attackBox.position.x, this.attackBox.position.y, this.attackBox.width, this.attackBox.height)
    ...
    // gravity function 
    if (this.position.y + this.height +this.velocity.y >= canvas.height - 47) {
      this.velocity.y = 0
  ...
  takeHit() {
    ...
    if (this.health <= 0) {
      ...
      setTimeout(function() {
        var userName = window.prompt("Hello, You are the winner of the game. May I know your name to properly congratulate you?");
     var str =  "Nice to meet you " + userName + "! " + "Congrats on your win, I hope you enjoyed the game!";
